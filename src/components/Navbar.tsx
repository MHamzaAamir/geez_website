...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed top-0 right-0 z-50 flex h-screen w-[82vw] max-w-90 flex-col bg-[#0D1025] p-6 text-white shadow-2xl transition-transform duration-300 ease-out md:hidden ${
